...
export default function ProspectosPublicoPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#1e3a8a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div style={{ background: '#0f1b3d', borderRadius: 16, padding: '28px 28px', maxWidth: 460, width: '100%', boxShadow: '0 20px 50px rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div>
              <h1 style={{ color: '#ffffff', fontSize: 17, fontWeight: 800, margin: 0 }}>CRM SPIN · Prospecto</h1>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <div style={{ gridColumn: 'span 2' }}>
              ...
              <textarea value={form.descripcion_requerimiento} onChange={e => set('descripcion_requerimiento', e.target.value)} rows={3}
                ...
                style={{ ...(errors.descripcion_requerimiento ? inputErr : inputStyle), resize: 'vertical', minHeight: 70 }} />
